...
<!--                  >列展示</n-checkbox-->
<!--                >-->
<!--&lt;!&ndash;                <n-checkbox v-model:checked="selection" @update:checked="onSelection"&ndash;&gt;-->
<!--&lt;!&ndash;                  >勾选列</n-checkbox&ndash;&gt;-->
<!--&lt;!&ndash;                >&ndash;&gt;-->
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      // }
      let checkList = table.getCacheColumns();
      const selectionItem = { type: 'selection', key: 'selection' };
      const foundItem = checkList.find(item=>item.key===selectionItem.key);
      if (!foundItem) {
        checkList.unshift(selectionItem);
        setColumns(checkList);
      }
