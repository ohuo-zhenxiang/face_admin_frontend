  ...
  <div class="tableAction">
    <div class="flex items-center justify-center">
      ...
      <n-dropdown
        ...
        @select="select as void"
      >
        <slot name="more"></slot>
        <n-button :type="getMoreProps.type === 'primary' ? 'primary' : 'default'" :size="getMoreProps.size" class="mx-2" v-if="!$slots.more" icon-placement="right">
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const getDropdownList = computed(() => {
        return (toRaw(props.dropDownActions as any) || [])
          .filter((action) => {
